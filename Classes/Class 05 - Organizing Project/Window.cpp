...
Window::Window()
	: m_Id(NULL), m_hInstance (GetModuleHandle(NULL)), m_Style(WS_OVERLAPPED | WS_SYSMENU | WS_EX_TOPMOST | WS_VISIBLE)
{
	// Title
...
void Window::SetDisplayMode(unsigned int DisplayMode)
{
	...
	{
		// Windowed
		m_Style = WS_OVERLAPPED | WS_SYSMENU | WS_EX_TOPMOST | WS_VISIBLE;
	}
