...
ID3D11Device*		 RGraphics::Device = nullptr;
ID3D11DeviceContext* RGraphics::Context = nullptr;
D3D11_VIEWPORT		 RGraphics::Viewport = { NULL };
...
bool RGraphics::Initialize(CWindow* Window)
{
	...
	SwapDesc.Windowed = (Window->GetDisplayMode() != CWindow::EDisplayMode::FULLSCREEN);
...
void RGraphics::SetVerticalSynchronization(bool Enable)
{
	// Set V-Sync
	m_VSync = Enable;
}

void RGraphics::ClearBuffer()
{
	// Clear back buffer
	Context->ClearRenderTargetView(m_RenderTargetView, m_BackgroundColor);
}

void RGraphics::PresentBuffer()
{
